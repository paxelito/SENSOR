...
for tmpDir in tmpDirs:
	...
	if os.path.isdir(totDirName):
		...
		# OVERALL TECH
		tmpFileName = os.path.join(totDirName,'_overall_tech_2.csv')
		try:
			fileFID = open(tmpFileName, 'r')
		except:
			print "_overall_tech_2 file has not been found: ", tmpFileName; sys.exit(1)
		fileFID = open(tmpFileName, 'r')
		#read file
		...
		try:
			...
			print "_overall_aids file has not been found: ", tmpFileName; sys.exit(1)
		fileFID = open(tmpFileName, 'r')
		#read file
		...
		try:
			...
			print "_overall_CO2 file has not been found: ", tmpFileName; sys.exit(1)
		fileFID = open(tmpFileName, 'r')
		#read file
		...
		try:
			...
			print "_overall_debt file has not been found: ", tmpFileName; sys.exit(1)
		fileFID = open(tmpFileName, 'r')
		#read file
		...
		try:
			...
			print "_overall_costs file has not been found: ", tmpFileName; sys.exit(1)
		fileFID = open(tmpFileName, 'r')
		#read file
...
FIlistFINAL = []; TCIListFINAL = []; nAgentsSolarFINAL = [];
for sr in results:
...
outFnameStat = '0_agents_perc.csv'
saveFileStat = open(outFnameStat, 'w')
